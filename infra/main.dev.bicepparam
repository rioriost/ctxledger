...
param postgresHighAvailabilityEnabled = false
...
param dbStatementTimeoutMs = 0
param dbSchemaName = 'public'
param dbPoolMinSize = 1
...
param mcpAuthMode = 'none'
param mcpAuthHeaderName = 'Authorization'
