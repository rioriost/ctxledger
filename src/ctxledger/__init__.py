...
def _format_stats_text(stats: object) -> str:
    ...
    lines = [
        ...
        f"- summary_backlog_count: {getattr(stats, 'summary_backlog_count', 0)}",
        "",
        "Completion summary build observability:",
            ...
            _print_json_payload(
                {
                    ...
                    "summary_backlog_count": getattr(stats, "summary_backlog_count", 0),
                    "completion_summary_build_request_count": getattr(
                        stats,
                        "completion_summary_build_request_count",
                        0,
                    ),
                    "completion_summary_build_attempted_count": getattr(
                        stats,
                        "completion_summary_build_attempted_count",
                        0,
                    ),
                    "completion_summary_build_success_count": getattr(
                        stats,
