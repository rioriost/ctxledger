...
- early comparison criteria for that later phase are captured in `docs/project/releases/plans/domains/auth/auth_large_gateway_evaluation_memo.md`
...
- the current comparison frame for gateway candidates is documented in `docs/project/releases/plans/domains/auth/auth_large_gateway_evaluation_memo.md`
...
7. evaluate large-pattern auth gateway candidates, using `docs/project/releases/plans/domains/auth/auth_large_gateway_evaluation_memo.md` as the design-prep baseline
